    ...
    public partial class CreateIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hall_Table", x => x.Hall_ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Showing_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name_Showing = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReGex_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Showing_ID = table.Column<int>(type: "int", nullable: false),
                    Hall_ID = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Number_of_Seats_Sold = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Showing_X_Hall", x => x.ReGex_ID);
                    table.ForeignKey(
                        name: "FK_Showing_X_Hall_Hall_Table_Hall_ID",
                        column: x => x.Hall_ID,
                        principalTable: "Hall_Table",
                        principalColumn: "Hall_ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Showing_X_Hall_Showing_Showing_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Showing_X_Hall_Hall_ID",
